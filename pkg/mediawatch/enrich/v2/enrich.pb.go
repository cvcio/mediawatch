...
var file_mediawatch_enrich_v2_enrich_proto_goTypes = []any{
...
func file_mediawatch_enrich_v2_enrich_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mediawatch_enrich_v2_enrich_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mediawatch_enrich_v2_enrich_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Entity); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mediawatch_enrich_v2_enrich_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*NLP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mediawatch_enrich_v2_enrich_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Data); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mediawatch_enrich_v2_enrich_proto_msgTypes[4].Exporter = func(v any, i int) any {
