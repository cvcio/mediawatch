...
var file_mediawatch_common_v2_common_proto_goTypes = []any{
...
func file_mediawatch_common_v2_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mediawatch_common_v2_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mediawatch_common_v2_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mediawatch_common_v2_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*SortBy); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mediawatch_common_v2_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
