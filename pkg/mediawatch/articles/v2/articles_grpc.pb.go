...
func (c *articlesServiceClient) GetArticles(ctx context.Context, in *QueryArticle, opts ...grpc.CallOption) (*ArticleList, error) {
	out := new(ArticleList)
	err := c.cc.Invoke(ctx, ArticlesService_GetArticles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articlesServiceClient) StreamArticles(ctx context.Context, in *QueryArticle, opts ...grpc.CallOption) (ArticlesService_StreamArticlesClient, error) {
	stream, err := c.cc.NewStream(ctx, &ArticlesService_ServiceDesc.Streams[0], ArticlesService_StreamArticles_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *articlesServiceClient) StreamRelatedArticles(ctx context.Context, in *QueryArticle, opts ...grpc.CallOption) (ArticlesService_StreamRelatedArticlesClient, error) {
	stream, err := c.cc.NewStream(ctx, &ArticlesService_ServiceDesc.Streams[1], ArticlesService_StreamRelatedArticles_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
