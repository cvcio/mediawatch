...
func (c *feedServiceClient) CreateFeed(ctx context.Context, in *Feed, opts ...grpc.CallOption) (*Feed, error) {
	out := new(Feed)
	err := c.cc.Invoke(ctx, FeedService_CreateFeed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) GetFeeds(ctx context.Context, in *QueryFeed, opts ...grpc.CallOption) (*FeedList, error) {
	out := new(FeedList)
	err := c.cc.Invoke(ctx, FeedService_GetFeeds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) DeleteFeed(ctx context.Context, in *Feed, opts ...grpc.CallOption) (*v2.ResponseWithMessage, error) {
	out := new(v2.ResponseWithMessage)
	err := c.cc.Invoke(ctx, FeedService_DeleteFeed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) GetFeedsStreamList(ctx context.Context, in *QueryFeed, opts ...grpc.CallOption) (*FeedList, error) {
	out := new(FeedList)
	err := c.cc.Invoke(ctx, FeedService_GetFeedsStreamList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) TestFeed(ctx context.Context, in *Feed, opts ...grpc.CallOption) (*FeedTest, error) {
	out := new(FeedTest)
	err := c.cc.Invoke(ctx, FeedService_TestFeed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FeedService_GetFeeds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FeedService_GetFeeds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FeedService_GetFeedsStreamList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FeedService_GetFeedsStreamList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FeedService_TestFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FeedService_TestFeed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
