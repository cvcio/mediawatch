...
func (c *feedServiceClient) GetFeeds(ctx context.Context, in *QueryFeed, opts ...grpc.CallOption) (*FeedList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FeedList)
	err := c.cc.Invoke(ctx, FeedService_GetFeeds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) GetFeedsStreamList(ctx context.Context, in *QueryFeed, opts ...grpc.CallOption) (*FeedList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FeedList)
	err := c.cc.Invoke(ctx, FeedService_GetFeedsStreamList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) TestFeed(ctx context.Context, in *Feed, opts ...grpc.CallOption) (*FeedTest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FeedTest)
	err := c.cc.Invoke(ctx, FeedService_TestFeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
