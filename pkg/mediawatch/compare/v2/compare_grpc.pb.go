...
func (c *compareServiceClient) Single(ctx context.Context, in *SingleRequest, opts ...grpc.CallOption) (*SingleResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompareService_Single_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *compareServiceClient) OneToMany(ctx context.Context, in *OneToManyRequest, opts ...grpc.CallOption) (*MultipleResponse, error) {
	...
	err := c.cc.Invoke(ctx, CompareService_OneToMany_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *compareServiceClient) ManyToMany(ctx context.Context, in *ManyToManyRequest, opts ...grpc.CallOption) (*MultipleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MultipleResponse)
	err := c.cc.Invoke(ctx, CompareService_ManyToMany_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCompareServiceServer should be embedded to have
...
func RegisterCompareServiceServer(s grpc.ServiceRegistrar, srv CompareServiceServer) {
	// If the following call pancis, it indicates UnimplementedCompareServiceServer was
