...
var file_mediawatch_passages_v2_passage_proto_goTypes = []any{
...
func file_mediawatch_passages_v2_passage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mediawatch_passages_v2_passage_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mediawatch_passages_v2_passage_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mediawatch_passages_v2_passage_proto_msgTypes[2].Exporter = func(v any, i int) any {
