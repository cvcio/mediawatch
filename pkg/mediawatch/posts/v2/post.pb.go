...
var file_mediawatch_posts_v2_post_proto_goTypes = []any{
...
func file_mediawatch_posts_v2_post_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mediawatch_posts_v2_post_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
		...
		file_mediawatch_posts_v2_post_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mediawatch_posts_v2_post_proto_msgTypes[2].Exporter = func(v any, i int) any {
