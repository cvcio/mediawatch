...
def test_extract_topics():
    model = Model("models/el.json")
    topics = extract_topics(test_text, model.topic_classification_pipeline)
    logging.info(topics)
    assert len(topics) == 2
...
def test_extract_named_entities():
    model = Model("models/el.json")
    entities = extract_named_entities(test_text, model.ner_classification_pipeline)
    logging.info(entities)
